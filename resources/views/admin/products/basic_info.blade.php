    ...
    <div class="card w-100 mt-2 mb-5">
        <div class="card-header d-flex justify-content-between">
            ...
            <div aria-label="breadcrumb" class="col-6">
                <ol class="breadcrumb step-container d-flex justify-content-between float-end">
                    <li class="step-circle mx-1" onclick="displayStep(1)">Basic Information</li>
                    <li class="step-circle mx-1" onclick="displayStep(2)">Additional Information</li>
                    <li class="step-circle mx-1" onclick="displayStep(3)">Sales Information</li>
                </ol>
            </div>
        </div>
                ...
                <div class="step step-1">
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            ...
                            <ul class="bg-white mt-2 list-unstyled" name="parentCategory " id="parentCategory">
                                @foreach ($categories as $categoryName)
                                    <li value="{{ $categoryName->id }}" class=" border-bottom px-2 py-1">
                        ...
                        <div class="col-6">
                            ...
                            <ul class="mt-2 bg-white list-unstyled px-2" name="childCategory" id="childCategory">
                            </ul>
                        </div>
                    </div>
                    <div class="row"><p class="categoryPreview"></p></div>
                    <div class="row mt-2">
        ...
        @push('scripts')
            ...
            <script>
                ...
                $('#parentCategory li').click(function() {
                    var data = $(this).val();
                    $(this).css("background-color", "lightblue");
                    $('.categoryPreview').append(data);
                    $.ajax({
                        data: {
                            'parentId': data
                        },
                        ...
                        success: function(data) {
                            $('#childCategory').empty();
                            for (item of data) {
                                $('#childCategory').append("<li class='border-bottom py-1'>" + item.name +
                                    "</li>")
                                    $('.categoryPreview').text(item.name)
                            }
                        },
                        error: function(data) {
                ...
                $('#childCategory li').click(function() {
                    $(this).css("background-color", "lightblue");
                });
                $('#parentCategory li').css("cursor", "pointer");
                $('#childCategory').css("cursor", "pointer");
